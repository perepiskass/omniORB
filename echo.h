...
public:
  // IDL operations
  ::CORBA::Boolean echoChar(::CORBA::Char symbol);
...
public:
  ...
  virtual ::CORBA::Boolean echoChar(::CORBA::Char symbol) = 0;
...
class Server : public POA_Echo
{
public:
  inline Server() {}
  virtual ~Server() {}
  virtual bool echoChar(::CORBA::Char symbol);
};
