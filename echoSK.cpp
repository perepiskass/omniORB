...
//
// Code for Echo::echoChar

// Proxy call descriptor class. Mangled signature:
//  _cboolean_i_cchar
class _0RL_cd_44f8bcded1b2746d_00000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_44f8bcded1b2746d_00000000(LocalCallFn lcfn, const char* op_, size_t oplen, _CORBA_Boolean upcall=0)
...
void _0RL_cd_44f8bcded1b2746d_00000000::marshalArguments(cdrStream& _n)
{
  _n.marshalChar(arg_0);

}

void _0RL_cd_44f8bcded1b2746d_00000000::unmarshalArguments(cdrStream& _n)
{
  arg_0 = _n.unmarshalChar();

}

void _0RL_cd_44f8bcded1b2746d_00000000::marshalReturnedValues(cdrStream& _n)
{
  _n.marshalBoolean(result);

}

void _0RL_cd_44f8bcded1b2746d_00000000::unmarshalReturnedValues(cdrStream& _n)
{
  result = _n.unmarshalBoolean();

}

const char* const _0RL_cd_44f8bcded1b2746d_00000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_44f8bcded1b2746d_10000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_44f8bcded1b2746d_00000000* tcd = (_0RL_cd_44f8bcded1b2746d_00000000*)cd;
...
::CORBA::Boolean _objref_Echo::echoChar(::CORBA::Char symbol)
{
  _0RL_cd_44f8bcded1b2746d_00000000 _call_desc(_0RL_lcfn_44f8bcded1b2746d_10000000, "echoChar", 9);
  _call_desc.arg_0 = symbol;
...
_impl_Echo::_dispatch(omniCallHandle& _handle)
{
  ...
  if (omni::strMatch(op, "echoChar")) {
    ...
    _0RL_cd_44f8bcded1b2746d_00000000 _call_desc(_0RL_lcfn_44f8bcded1b2746d_10000000, "echoChar", 9, 1);
...
bool Server::echoChar(::CORBA::Char symbol)
{
    try
    {
        std::cout << symbol;
